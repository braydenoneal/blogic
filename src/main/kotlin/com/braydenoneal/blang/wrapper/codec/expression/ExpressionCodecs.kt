...
object ExpressionCodecs {
    ...
    val STRUCT_EXPRESSION_CODEC: MapCodec<StructExpression> = mapCodec {
        it.group(
            Codec.list(pair(Codec.STRING, ExpressionType.CODEC)).fieldOf("expressions").forGetter(StructExpression::expressions),
    ...
    val LIST_APPEND_BUILTIN_CODEC: MapCodec<ListAppendBuiltin> = mapCodec {
        it.group(
            LIST_VALUE_CODEC.fieldOf("listValue").forGetter(ListAppendBuiltin::listValue),
    ...
    val LIST_CONTAINS_ALL_BUILTIN_CODEC: MapCodec<ListContainsAllBuiltin> = mapCodec {
        it.group(
            LIST_VALUE_CODEC.fieldOf("listValue").forGetter(ListContainsAllBuiltin::listValue),
    ...
    val LIST_CONTAINS_BUILTIN_CODEC: MapCodec<ListContainsBuiltin> = mapCodec {
        it.group(
            LIST_VALUE_CODEC.fieldOf("listValue").forGetter(ListContainsBuiltin::listValue),
    ...
    val LIST_INSERT_BUILTIN_CODEC: MapCodec<ListInsertBuiltin> = mapCodec {
        it.group(
            LIST_VALUE_CODEC.fieldOf("listValue").forGetter(ListInsertBuiltin::listValue),
    ...
    val LIST_POP_BUILTIN_CODEC: MapCodec<ListPopBuiltin> = mapCodec {
        it.group(
            LIST_VALUE_CODEC.fieldOf("listValue").forGetter(ListPopBuiltin::listValue),
    ...
    val LIST_REMOVE_BUILTIN_CODEC: MapCodec<ListRemoveBuiltin> = mapCodec {
        it.group(
            LIST_VALUE_CODEC.fieldOf("listValue").forGetter(ListRemoveBuiltin::listValue),
    ...
    val STRUCT_ENTRIES_BUILTIN_CODEC: MapCodec<StructEntriesBuiltin> = mapCodec {
        it.group(
            STRUCT_VALUE_CODEC.fieldOf("struct").forGetter(StructEntriesBuiltin::struct),
    ...
    val STRUCT_KEYS_BUILTIN_CODEC: MapCodec<StructKeysBuiltin> = mapCodec {
        it.group(
            STRUCT_VALUE_CODEC.fieldOf("struct").forGetter(StructKeysBuiltin::struct),
    ...
    val STRUCT_REMOVE_BUILTIN_CODEC: MapCodec<StructRemoveBuiltin> = mapCodec {
        it.group(
            STRUCT_VALUE_CODEC.fieldOf("struct").forGetter(StructRemoveBuiltin::struct),
