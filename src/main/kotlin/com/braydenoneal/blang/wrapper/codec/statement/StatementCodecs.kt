...
import com.braydenoneal.blang.wrapper.codec.value.ValueCodecs.FUNCT_CODEC
...
object StatementCodecs {
    ...
    val ELSE_IF_STATEMENT_CODEC: Codec<ElseIfStatement> = RecordCodecBuilder.create {
        it.group(
            ...
            ValueType.CODEC.fieldOf("conditionValue").forGetter(ElseIfStatement::conditionValue),
    ...
    val IF_STATEMENT_CODEC: MapCodec<IfStatement> = mapCodec {
        it.group(
            ...
            ValueType.CODEC.fieldOf("conditionValue").forGetter(IfStatement::conditionValue),
