...
class ModBlockEntities {
    companion object {
        ...
        val CONTROLLER_SCREEN_HANDLER: ExtendedScreenHandlerType<ControllerScreenHandler, BlockPos> = Registry.register<ScreenHandlerType<*>, ExtendedScreenHandlerType<ControllerScreenHandler, BlockPos>>(
